        ...
        if ( ! empty( $project_posts ) ) {
          ...
          foreach ( $project_posts as $post ) {
            ...
            <article class="project-card fade-in">
              <a href="<?php echo esc_url( portfolio_get_project_list_link() ); ?>" class="project-link"<?php echo portfolio_project_list_link_is_external() ? ' target="_blank" rel="noopener noreferrer"' : ''; ?>>
