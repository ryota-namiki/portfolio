    ...
    <nav class="navbar">
      <div class="navbar-container">
        <div class="site-branding">
          <h1 class="site-title">
            <a href="<?php echo esc_url( home_url( '/projects/' ) ); ?>" rel="home">
        ...
        <div class="navbar-actions">
          <div class="navbar-buttons">
            <a href="<?php echo esc_url( get_post_type_archive_link( 'projects' ) ); ?>" class="navbar-btn navbar-btn-dark">
    ...
    <div class="nav-overlay__content">
      <ul class="nav-overlay__list">
        <li class="nav-overlay__item">
          <a href=""<?php echo esc_url( get_post_type_archive_link( 'projects' ) ); ?>" class="nav-overlay__link">ホーム</a>
        </li>
        <li class="nav-overlay__item">
          <a href="<?php echo esc_url( get_post_type_archive_link( 'projects' ) ); ?>" class="nav-overlay__link">制作実績</a>
        </li>
      </ul>
    </div>
  </nav>
